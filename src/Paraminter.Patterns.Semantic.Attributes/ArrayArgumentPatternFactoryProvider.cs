...
public sealed class ArrayArgumentPatternFactoryProvider
    : IArrayArgumentPatternFactoryProvider
{
    ...
    public ArrayArgumentPatternFactoryProvider(
        INonNullableArrayArgumentPatternFactory nonNullable,
        INullableArrayArgumentPatternFactory nullable)
    {

...
public sealed class NullableObjectArgumentPatternFactory
    : INullableObjectArgumentPatternFactory
{
    ...
    public NullableObjectArgumentPatternFactory(
        INonNullableObjectArgumentPatternFactory nonNullablePatternFactory,
    ...
    private sealed class NullableObjectArgumentPattern
        : IArgumentPattern<TypedConstant, object?>
    {
        ...
        public NullableObjectArgumentPattern(
            IArgumentPattern<TypedConstant, object> nonNullablePattern,
            IArgumentPatternMatchResultFactoryProvider matchResultFactoryProvider)
        {

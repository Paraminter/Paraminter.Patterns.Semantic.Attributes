...
public sealed class Constructor
{
    ...
    private static ULongArgumentPatternFactory Target(IArgumentPatternMatchResultFactoryProvider matchResultFactoryProvider) => new(matchResultFactoryProvider);
}

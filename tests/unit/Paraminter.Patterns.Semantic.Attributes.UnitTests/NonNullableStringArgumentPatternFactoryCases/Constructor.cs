...
public sealed class Constructor
{
    ...
    private static NonNullableStringArgumentPatternFactory Target(IArgumentPatternMatchResultFactoryProvider matchResultFactoryProvider) => new(matchResultFactoryProvider);
}

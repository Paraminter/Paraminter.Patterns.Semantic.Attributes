...
internal static class FactoryFixtureFactory
{
    ...
    private sealed class FactoryFixture : IFactoryFixture
    {
        ...
        public FactoryFixture(INullableTypeArgumentPatternFactory sut, Mock<INonNullableTypeArgumentPatternFactory> nonNullablePatternFactoryMock, Mock<IArgumentPatternMatchResultFactoryProvider> matchResultFactoryProviderMock)
        {
            Sut = sut;

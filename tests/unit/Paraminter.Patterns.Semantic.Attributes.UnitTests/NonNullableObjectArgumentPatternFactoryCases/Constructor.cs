...
public sealed class Constructor
{
    ...
    private static NonNullableObjectArgumentPatternFactory Target(IArgumentPatternMatchResultFactoryProvider matchResultFactoryProvider) => new(matchResultFactoryProvider);
}

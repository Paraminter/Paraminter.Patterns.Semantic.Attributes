...
public sealed class Constructor
{
    ...
    private static NonNullableArrayArgumentPatternFactory Target(IArgumentPatternMatchResultFactoryProvider matchResultFactoryProvider) => new(matchResultFactoryProvider);
}

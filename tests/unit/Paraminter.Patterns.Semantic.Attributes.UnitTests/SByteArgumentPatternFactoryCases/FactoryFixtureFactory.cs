...
internal static class FactoryFixtureFactory
{
    public static IFactoryFixture Create()
    {
        ...
        SByteArgumentPatternFactory sut = new(matchResultFactoryProviderMock.Object);
    ...
    private sealed class FactoryFixture : IFactoryFixture
    {
        ...
        public FactoryFixture(ISByteArgumentPatternFactory sut, Mock<IArgumentPatternMatchResultFactoryProvider> matchResultFactoryProviderMock)
        {
            Sut = sut;

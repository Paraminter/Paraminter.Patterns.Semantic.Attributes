...
public sealed class Constructor
{
    ...
    private static NullableObjectArgumentPatternFactory Target(
    ...
    {
        return new NullableObjectArgumentPatternFactory(nonNullablePatternFactory, matchResultFactoryProvider);
    }
}

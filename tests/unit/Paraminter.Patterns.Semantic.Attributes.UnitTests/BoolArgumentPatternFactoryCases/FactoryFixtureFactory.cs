...
internal static class FactoryFixtureFactory
{
    public static IFactoryFixture Create()
    {
        ...
        BoolArgumentPatternFactory sut = new(matchResultFactoryProviderMock.Object);
    ...
    private sealed class FactoryFixture : IFactoryFixture
    {
        ...
        public FactoryFixture(IBoolArgumentPatternFactory sut, Mock<IArgumentPatternMatchResultFactoryProvider> matchResultFactoryProviderMock)
        {
            Sut = sut;

...
{
    private static ArgumentPatternMatchResult<long> Target(IArgumentPattern<TypedConstant, long> pattern, TypedConstant argument) => pattern.TryMatch(argument);
    ...
    [AssertionMethod]
    private static void Successful(long expected, string source)
    {
